...
public class Playground extends SurfaceView implements View.OnTouchListener {
    ...
    private static final int BLOCKS = 15;//榛樿娣诲姞鐨勮矾闅滄暟閲�
...
//		System.out.println("X:"+one.getX()+" Y:"+one.getY()+" Dir:"+dir);
    ...
    private void move() {
        ...
        if (avaliable.size() == 0) {
            ...
            Dot best = null;
            if (positive.size() != 0 ) {//瀛樺湪鍙互鐩存帴鍒拌揪灞忓箷杈圭紭鐨勮蛋鍚�				System.out.println("鍚戝墠杩�);
                int min = 999;
                ...
                MoveTo(best);
            }else {//鎵�湁鏂瑰悜閮藉瓨鍦ㄨ矾闅�				System.out.println("韬茶矾闅�);
                int max = 0;
